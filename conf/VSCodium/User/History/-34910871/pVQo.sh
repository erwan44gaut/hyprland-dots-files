...
yay -Syu hyprland swaylock vscodium nerd-fonts-complete waybar wayshot neofetch hyprpaper thunar --noconfirm

mkdir /home/$USER_NAME/wallpaperls -la
cp -r ./hyprland-dots-files/conf/wallpaper /home/$USER_NAME/wallpaper
